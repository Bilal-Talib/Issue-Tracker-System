                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="{{ route('register') }}" method="post" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                <label for="userRole" style="position: absolute;left: 0;top: 50%;" class="flex items-center "><i class="zmdi zmdi-account material-icons-name text-white ml-1"></i></label>
                                <select class="form-select bg-[#22272B] text-white pl-6" id="userRole" name="user_role" aria-label="Default select example">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="{{route('loginUI')}}" class="signup-image-link text-white">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
